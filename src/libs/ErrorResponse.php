...
class ErrorResponse extends Response{
    ...
    protected static $message404='EXTRAVIADO.';
	...
	public static function error_404($description,$message=null,){
        return self::response($message??self::$message404,$description,'404',self::$message404);
    }
